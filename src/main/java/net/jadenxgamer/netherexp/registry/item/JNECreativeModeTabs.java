...
public class JNECreativeModeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, NetherExp.MOD_ID);

    public static final RegistryObject<CreativeModeTab> NETHEREXP = CREATIVE_MODE_TABS.register("netherexp",
...
//                        output.accept(JNEBlocks.SMOOTH_SILICA_SANDSTONE_SLAB.get());
    ...
    public static final RegistryObject<CreativeModeTab> NETHEREXP_COMPAT = CREATIVE_MODE_TABS.register("netherexp_compat",
